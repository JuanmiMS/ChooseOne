...
class QuestionComponent extends Component {
    ...
    getRandomQuestion = user => {
        let url = "http://localhost:8080/api/pregunta/getRandom/:id/:question".replace(":id", firebase.auth().O).replace(":question", this.state.id)
    ...
    logAnswer = resp => {
        ...
        axios.post(`http://localhost:8080/api/respuesta`, { model })
            .then(res => {
    ...
    render() {
        return (
            <main className="container">
                <img id="carga" alt="" src="https://3wga6448744j404mpt11pbx4-wpengine.netdna-ssl.com/wp-content/uploads/2015/05/InternetSlowdown_Day.gif" />
